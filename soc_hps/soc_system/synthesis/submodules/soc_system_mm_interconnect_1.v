...
module soc_system_mm_interconnect_1 (
	...
	wire  [115:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                               // JTAG_UART_avalon_jtag_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [115:0] buttons_s1_agent_rp_data;                                                // BUTTONS_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [115:0] timer_s1_agent_rp_data;                                                  // TIMER_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] seven_segments_s1_agent_rp_data;                                         // SEVEN_SEGMENTS_s1_agent:rp_data -> router_006:sink_data
	...
	wire    [4:0] cmd_mux_src_channel;                                                     // cmd_mux:src_channel -> AUDIO_CONFIG_avalon_av_config_slave_burst_adapter:sink0_channel
	...
	wire    [4:0] audio_config_avalon_av_config_slave_burst_adapter_source0_channel;       // AUDIO_CONFIG_avalon_av_config_slave_burst_adapter:source0_channel -> AUDIO_CONFIG_avalon_av_config_slave_agent:cp_channel
	...
	wire  [115:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> JTAG_UART_avalon_jtag_slave_burst_adapter:sink0_data
	...
	wire          cmd_mux_002_src_valid;                                                   // cmd_mux_002:src_valid -> BUTTONS_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_002_src_data;                                                    // cmd_mux_002:src_data -> BUTTONS_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                   // BUTTONS_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                 // cmd_mux_002:src_channel -> BUTTONS_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                           // cmd_mux_002:src_startofpacket -> BUTTONS_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                             // cmd_mux_002:src_endofpacket -> BUTTONS_s1_burst_adapter:sink0_endofpacket
	...
	wire    [4:0] buttons_s1_burst_adapter_source0_channel;                                // BUTTONS_s1_burst_adapter:source0_channel -> BUTTONS_s1_agent:cp_channel
	...
	wire          cmd_mux_003_src_valid;                                                   // cmd_mux_003:src_valid -> TIMER_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_003_src_data;                                                    // cmd_mux_003:src_data -> TIMER_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                   // TIMER_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                 // cmd_mux_003:src_channel -> TIMER_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                           // cmd_mux_003:src_startofpacket -> TIMER_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                             // cmd_mux_003:src_endofpacket -> TIMER_s1_burst_adapter:sink0_endofpacket
	...
	wire    [4:0] timer_s1_burst_adapter_source0_channel;                                  // TIMER_s1_burst_adapter:source0_channel -> TIMER_s1_agent:cp_channel
	...
	wire          cmd_mux_004_src_valid;                                                   // cmd_mux_004:src_valid -> SEVEN_SEGMENTS_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_004_src_data;                                                    // cmd_mux_004:src_data -> SEVEN_SEGMENTS_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                   // SEVEN_SEGMENTS_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                 // cmd_mux_004:src_channel -> SEVEN_SEGMENTS_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                           // cmd_mux_004:src_startofpacket -> SEVEN_SEGMENTS_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                             // cmd_mux_004:src_endofpacket -> SEVEN_SEGMENTS_s1_burst_adapter:sink0_endofpacket
	...
	wire    [4:0] seven_segments_s1_burst_adapter_source0_channel;                         // SEVEN_SEGMENTS_s1_burst_adapter:source0_channel -> SEVEN_SEGMENTS_s1_agent:cp_channel
	...
	wire          buttons_s1_agent_rdata_fifo_out_valid;                                   // BUTTONS_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] buttons_s1_agent_rdata_fifo_out_data;                                    // BUTTONS_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          buttons_s1_agent_rdata_fifo_out_ready;                                   // avalon_st_adapter_002:in_0_ready -> BUTTONS_s1_agent_rdata_fifo:out_ready
	...
	wire          seven_segments_s1_agent_rdata_fifo_out_valid;                            // SEVEN_SEGMENTS_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] seven_segments_s1_agent_rdata_fifo_out_data;                             // SEVEN_SEGMENTS_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          seven_segments_s1_agent_rdata_fifo_out_ready;                            // avalon_st_adapter_004:in_0_ready -> SEVEN_SEGMENTS_s1_agent_rdata_fifo:out_ready
