...
module soc_system_mm_interconnect_0 (
	...
	wire   [29:0] audio_avalon_audio_slave_agent_m0_address;                    // AUDIO_avalon_audio_slave_agent:m0_address -> AUDIO_avalon_audio_slave_translator:uav_address
	...
	wire  [123:0] audio_avalon_audio_slave_agent_rf_source_data;                // AUDIO_avalon_audio_slave_agent:rf_source_data -> AUDIO_avalon_audio_slave_agent_rsp_fifo:in_data
	...
	wire  [123:0] audio_avalon_audio_slave_agent_rsp_fifo_out_data;             // AUDIO_avalon_audio_slave_agent_rsp_fifo:out_data -> AUDIO_avalon_audio_slave_agent:rf_sink_data
	...
	wire  [122:0] audio_avalon_audio_slave_agent_rp_data;                       // AUDIO_avalon_audio_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [122:0] audio_avalon_audio_slave_burst_adapter_source0_data;          // AUDIO_avalon_audio_slave_burst_adapter:source0_data -> AUDIO_avalon_audio_slave_agent:cp_data
	...
	wire    [1:0] audio_avalon_audio_slave_burst_adapter_source0_channel;       // AUDIO_avalon_audio_slave_burst_adapter:source0_channel -> AUDIO_avalon_audio_slave_agent:cp_channel
	...
	wire          router_002_src_valid;                                         // router_002:src_valid -> AUDIO_avalon_audio_slave_rsp_width_adapter:in_valid
	wire  [122:0] router_002_src_data;                                          // router_002:src_data -> AUDIO_avalon_audio_slave_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                         // AUDIO_avalon_audio_slave_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                       // router_002:src_channel -> AUDIO_avalon_audio_slave_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                 // router_002:src_startofpacket -> AUDIO_avalon_audio_slave_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                   // router_002:src_endofpacket -> AUDIO_avalon_audio_slave_rsp_width_adapter:in_endofpacket
	wire          audio_avalon_audio_slave_rsp_width_adapter_src_valid;         // AUDIO_avalon_audio_slave_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [158:0] audio_avalon_audio_slave_rsp_width_adapter_src_data;          // AUDIO_avalon_audio_slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          audio_avalon_audio_slave_rsp_width_adapter_src_ready;         // rsp_demux:sink_ready -> AUDIO_avalon_audio_slave_rsp_width_adapter:out_ready
	wire    [1:0] audio_avalon_audio_slave_rsp_width_adapter_src_channel;       // AUDIO_avalon_audio_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          audio_avalon_audio_slave_rsp_width_adapter_src_startofpacket; // AUDIO_avalon_audio_slave_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          audio_avalon_audio_slave_rsp_width_adapter_src_endofpacket;   // AUDIO_avalon_audio_slave_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                            // cmd_mux:src_valid -> AUDIO_avalon_audio_slave_cmd_width_adapter:in_valid
	wire  [158:0] cmd_mux_src_data;                                             // cmd_mux:src_data -> AUDIO_avalon_audio_slave_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                            // AUDIO_avalon_audio_slave_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                          // cmd_mux:src_channel -> AUDIO_avalon_audio_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                    // cmd_mux:src_startofpacket -> AUDIO_avalon_audio_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                      // cmd_mux:src_endofpacket -> AUDIO_avalon_audio_slave_cmd_width_adapter:in_endofpacket
	wire          audio_avalon_audio_slave_cmd_width_adapter_src_valid;         // AUDIO_avalon_audio_slave_cmd_width_adapter:out_valid -> AUDIO_avalon_audio_slave_burst_adapter:sink0_valid
	wire  [122:0] audio_avalon_audio_slave_cmd_width_adapter_src_data;          // AUDIO_avalon_audio_slave_cmd_width_adapter:out_data -> AUDIO_avalon_audio_slave_burst_adapter:sink0_data
	wire          audio_avalon_audio_slave_cmd_width_adapter_src_ready;         // AUDIO_avalon_audio_slave_burst_adapter:sink0_ready -> AUDIO_avalon_audio_slave_cmd_width_adapter:out_ready
	wire    [1:0] audio_avalon_audio_slave_cmd_width_adapter_src_channel;       // AUDIO_avalon_audio_slave_cmd_width_adapter:out_channel -> AUDIO_avalon_audio_slave_burst_adapter:sink0_channel
	wire          audio_avalon_audio_slave_cmd_width_adapter_src_startofpacket; // AUDIO_avalon_audio_slave_cmd_width_adapter:out_startofpacket -> AUDIO_avalon_audio_slave_burst_adapter:sink0_startofpacket
	wire          audio_avalon_audio_slave_cmd_width_adapter_src_endofpacket;   // AUDIO_avalon_audio_slave_cmd_width_adapter:out_endofpacket -> AUDIO_avalon_audio_slave_burst_adapter:sink0_endofpacket
	...
	altera_merlin_burst_adapter #(
		...
		.sink0_valid           (audio_avalon_audio_slave_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (audio_avalon_audio_slave_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (audio_avalon_audio_slave_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (audio_avalon_audio_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (audio_avalon_audio_slave_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (audio_avalon_audio_slave_cmd_width_adapter_src_ready),         //          .ready
	...
	soc_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (AUDIO_reset_reset_bridge_in_reset_reset),                      // clk_reset.reset
		.sink_ready         (audio_avalon_audio_slave_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (audio_avalon_audio_slave_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (audio_avalon_audio_slave_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (audio_avalon_audio_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (audio_avalon_audio_slave_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (audio_avalon_audio_slave_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) audio_avalon_audio_slave_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                                //       clk.clk
		.reset                (AUDIO_reset_reset_bridge_in_reset_reset),                      // clk_reset.reset
		...
		.out_endofpacket      (audio_avalon_audio_slave_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (audio_avalon_audio_slave_rsp_width_adapter_src_data),          //          .data
		.out_channel          (audio_avalon_audio_slave_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (audio_avalon_audio_slave_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (audio_avalon_audio_slave_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (audio_avalon_audio_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) audio_avalon_audio_slave_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                                //       clk.clk
		.reset                (AUDIO_reset_reset_bridge_in_reset_reset),                      // clk_reset.reset
		...
		.out_endofpacket      (audio_avalon_audio_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (audio_avalon_audio_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (audio_avalon_audio_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (audio_avalon_audio_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (audio_avalon_audio_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (audio_avalon_audio_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                        // (terminated)
	);
