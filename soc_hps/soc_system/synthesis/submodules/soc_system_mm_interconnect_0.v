...
module soc_system_mm_interconnect_0 (
	...
	wire  [116:0] audio_avalon_audio_slave_agent_rf_source_data;                           // AUDIO_avalon_audio_slave_agent:rf_source_data -> AUDIO_avalon_audio_slave_agent_rsp_fifo:in_data
	...
	wire  [116:0] audio_avalon_audio_slave_agent_rsp_fifo_out_data;                        // AUDIO_avalon_audio_slave_agent_rsp_fifo:out_data -> AUDIO_avalon_audio_slave_agent:rf_sink_data
	...
	wire  [116:0] timer_s1_agent_rf_source_data;                                           // TIMER_s1_agent:rf_source_data -> TIMER_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] timer_s1_agent_rsp_fifo_out_data;                                        // TIMER_s1_agent_rsp_fifo:out_data -> TIMER_s1_agent:rf_sink_data
	...
	wire  [116:0] seven_segments_s1_agent_rf_source_data;                                  // SEVEN_SEGMENTS_s1_agent:rf_source_data -> SEVEN_SEGMENTS_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] seven_segments_s1_agent_rsp_fifo_out_data;                               // SEVEN_SEGMENTS_s1_agent_rsp_fifo:out_data -> SEVEN_SEGMENTS_s1_agent:rf_sink_data
	...
	wire  [115:0] audio_avalon_audio_slave_agent_rp_data;                                  // AUDIO_avalon_audio_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [115:0] audio_config_avalon_av_config_slave_agent_rp_data;                       // AUDIO_CONFIG_avalon_av_config_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [115:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                               // JTAG_UART_avalon_jtag_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [115:0] buttons_s1_agent_rp_data;                                                // BUTTONS_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] timer_s1_agent_rp_data;                                                  // TIMER_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [115:0] seven_segments_s1_agent_rp_data;                                         // SEVEN_SEGMENTS_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [115:0] cmd_mux_src_data;                                                        // cmd_mux:src_data -> AUDIO_avalon_audio_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                       // AUDIO_avalon_audio_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [5:0] cmd_mux_src_channel;                                                     // cmd_mux:src_channel -> AUDIO_avalon_audio_slave_burst_adapter:sink0_channel
	...
	wire  [115:0] audio_avalon_audio_slave_burst_adapter_source0_data;                     // AUDIO_avalon_audio_slave_burst_adapter:source0_data -> AUDIO_avalon_audio_slave_agent:cp_data
	...
	wire    [5:0] audio_avalon_audio_slave_burst_adapter_source0_channel;                  // AUDIO_avalon_audio_slave_burst_adapter:source0_channel -> AUDIO_avalon_audio_slave_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                                   // cmd_mux_001:src_valid -> AUDIO_CONFIG_avalon_av_config_slave_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> AUDIO_CONFIG_avalon_av_config_slave_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                   // AUDIO_CONFIG_avalon_av_config_slave_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                                 // cmd_mux_001:src_channel -> AUDIO_CONFIG_avalon_av_config_slave_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                           // cmd_mux_001:src_startofpacket -> AUDIO_CONFIG_avalon_av_config_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                             // cmd_mux_001:src_endofpacket -> AUDIO_CONFIG_avalon_av_config_slave_burst_adapter:sink0_endofpacket
	...
	wire    [5:0] audio_config_avalon_av_config_slave_burst_adapter_source0_channel;       // AUDIO_CONFIG_avalon_av_config_slave_burst_adapter:source0_channel -> AUDIO_CONFIG_avalon_av_config_slave_agent:cp_channel
	...
	wire  [115:0] cmd_mux_002_src_data;                                                    // cmd_mux_002:src_data -> JTAG_UART_avalon_jtag_slave_burst_adapter:sink0_data
	...
	wire          cmd_mux_003_src_valid;                                                   // cmd_mux_003:src_valid -> BUTTONS_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_003_src_data;                                                    // cmd_mux_003:src_data -> BUTTONS_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                   // BUTTONS_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                 // cmd_mux_003:src_channel -> BUTTONS_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                           // cmd_mux_003:src_startofpacket -> BUTTONS_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                             // cmd_mux_003:src_endofpacket -> BUTTONS_s1_burst_adapter:sink0_endofpacket
	...
	wire    [5:0] buttons_s1_burst_adapter_source0_channel;                                // BUTTONS_s1_burst_adapter:source0_channel -> BUTTONS_s1_agent:cp_channel
	...
	wire          cmd_mux_004_src_valid;                                                   // cmd_mux_004:src_valid -> TIMER_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_004_src_data;                                                    // cmd_mux_004:src_data -> TIMER_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                   // TIMER_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                 // cmd_mux_004:src_channel -> TIMER_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                           // cmd_mux_004:src_startofpacket -> TIMER_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                             // cmd_mux_004:src_endofpacket -> TIMER_s1_burst_adapter:sink0_endofpacket
	wire          timer_s1_burst_adapter_source0_valid;                                    // TIMER_s1_burst_adapter:source0_valid -> TIMER_s1_agent:cp_valid
	wire  [115:0] timer_s1_burst_adapter_source0_data;                                     // TIMER_s1_burst_adapter:source0_data -> TIMER_s1_agent:cp_data
	wire          timer_s1_burst_adapter_source0_ready;                                    // TIMER_s1_agent:cp_ready -> TIMER_s1_burst_adapter:source0_ready
	wire    [5:0] timer_s1_burst_adapter_source0_channel;                                  // TIMER_s1_burst_adapter:source0_channel -> TIMER_s1_agent:cp_channel
	...
	wire          cmd_mux_005_src_valid;                                                   // cmd_mux_005:src_valid -> SEVEN_SEGMENTS_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_005_src_data;                                                    // cmd_mux_005:src_data -> SEVEN_SEGMENTS_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                   // SEVEN_SEGMENTS_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                 // cmd_mux_005:src_channel -> SEVEN_SEGMENTS_s1_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                           // cmd_mux_005:src_startofpacket -> SEVEN_SEGMENTS_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                             // cmd_mux_005:src_endofpacket -> SEVEN_SEGMENTS_s1_burst_adapter:sink0_endofpacket
	wire          seven_segments_s1_burst_adapter_source0_valid;                           // SEVEN_SEGMENTS_s1_burst_adapter:source0_valid -> SEVEN_SEGMENTS_s1_agent:cp_valid
	wire  [115:0] seven_segments_s1_burst_adapter_source0_data;                            // SEVEN_SEGMENTS_s1_burst_adapter:source0_data -> SEVEN_SEGMENTS_s1_agent:cp_data
	wire          seven_segments_s1_burst_adapter_source0_ready;                           // SEVEN_SEGMENTS_s1_agent:cp_ready -> SEVEN_SEGMENTS_s1_burst_adapter:source0_ready
	wire    [5:0] seven_segments_s1_burst_adapter_source0_channel;                         // SEVEN_SEGMENTS_s1_burst_adapter:source0_channel -> SEVEN_SEGMENTS_s1_agent:cp_channel
	wire          seven_segments_s1_burst_adapter_source0_startofpacket;                   // SEVEN_SEGMENTS_s1_burst_adapter:source0_startofpacket -> SEVEN_SEGMENTS_s1_agent:cp_startofpacket
	wire          seven_segments_s1_burst_adapter_source0_endofpacket;                     // SEVEN_SEGMENTS_s1_burst_adapter:source0_endofpacket -> SEVEN_SEGMENTS_s1_agent:cp_endofpacket
	...
	wire          seven_segments_s1_agent_rdata_fifo_out_valid;                            // SEVEN_SEGMENTS_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] seven_segments_s1_agent_rdata_fifo_out_data;                             // SEVEN_SEGMENTS_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          seven_segments_s1_agent_rdata_fifo_out_ready;                            // avalon_st_adapter_005:in_0_ready -> SEVEN_SEGMENTS_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (seven_segments_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (seven_segments_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (seven_segments_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (seven_segments_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (seven_segments_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (seven_segments_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) seven_segments_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                         //       cr0.clk
		.reset                 (AUDIO_reset_reset_bridge_in_reset_reset),               // cr0_reset.reset
		...
		.source0_valid         (seven_segments_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (seven_segments_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (seven_segments_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (seven_segments_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (seven_segments_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (seven_segments_s1_burst_adapter_source0_ready)          //          .ready
	);
