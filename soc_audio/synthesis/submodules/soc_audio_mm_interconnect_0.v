...
`timescale 1 ps / 1 ps
module soc_audio_mm_interconnect_0 (
		...
		output wire        ADDRESS_EXTENDER_cntl_write,                   //             ADDRESS_EXTENDER_cntl.write
		output wire        ADDRESS_EXTENDER_cntl_read,                    //                                  .read
		input  wire [63:0] ADDRESS_EXTENDER_cntl_readdata,                //                                  .readdata
		output wire [63:0] ADDRESS_EXTENDER_cntl_writedata,               //                                  .writedata
		output wire [7:0]  ADDRESS_EXTENDER_cntl_byteenable,              //                                  .byteenable
		output wire [15:0] ADDRESS_EXTENDER_windowed_slave_address,       //   ADDRESS_EXTENDER_windowed_slave.address
		output wire        ADDRESS_EXTENDER_windowed_slave_write,         //                                  .write
		output wire        ADDRESS_EXTENDER_windowed_slave_read,          //                                  .read
		input  wire [31:0] ADDRESS_EXTENDER_windowed_slave_readdata,      //                                  .readdata
		output wire [31:0] ADDRESS_EXTENDER_windowed_slave_writedata,     //                                  .writedata
		output wire [0:0]  ADDRESS_EXTENDER_windowed_slave_burstcount,    //                                  .burstcount
		output wire [3:0]  ADDRESS_EXTENDER_windowed_slave_byteenable,    //                                  .byteenable
		input  wire        ADDRESS_EXTENDER_windowed_slave_readdatavalid, //                                  .readdatavalid
		input  wire        ADDRESS_EXTENDER_windowed_slave_waitrequest,   //                                  .waitrequest
	...
	wire   [97:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> NIOS_data_master_agent:rp_data
	...
	wire   [97:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> NIOS_instruction_master_agent:rp_data
	...
	wire   [63:0] address_extender_cntl_agent_m0_readdata;                                    // ADDRESS_EXTENDER_cntl_translator:uav_readdata -> ADDRESS_EXTENDER_cntl_agent:m0_readdata
	wire          address_extender_cntl_agent_m0_waitrequest;                                 // ADDRESS_EXTENDER_cntl_translator:uav_waitrequest -> ADDRESS_EXTENDER_cntl_agent:m0_waitrequest
	wire          address_extender_cntl_agent_m0_debugaccess;                                 // ADDRESS_EXTENDER_cntl_agent:m0_debugaccess -> ADDRESS_EXTENDER_cntl_translator:uav_debugaccess
	wire   [18:0] address_extender_cntl_agent_m0_address;                                     // ADDRESS_EXTENDER_cntl_agent:m0_address -> ADDRESS_EXTENDER_cntl_translator:uav_address
	wire    [7:0] address_extender_cntl_agent_m0_byteenable;                                  // ADDRESS_EXTENDER_cntl_agent:m0_byteenable -> ADDRESS_EXTENDER_cntl_translator:uav_byteenable
	wire          address_extender_cntl_agent_m0_read;                                        // ADDRESS_EXTENDER_cntl_agent:m0_read -> ADDRESS_EXTENDER_cntl_translator:uav_read
	wire          address_extender_cntl_agent_m0_readdatavalid;                               // ADDRESS_EXTENDER_cntl_translator:uav_readdatavalid -> ADDRESS_EXTENDER_cntl_agent:m0_readdatavalid
	wire          address_extender_cntl_agent_m0_lock;                                        // ADDRESS_EXTENDER_cntl_agent:m0_lock -> ADDRESS_EXTENDER_cntl_translator:uav_lock
	wire   [63:0] address_extender_cntl_agent_m0_writedata;                                   // ADDRESS_EXTENDER_cntl_agent:m0_writedata -> ADDRESS_EXTENDER_cntl_translator:uav_writedata
	wire          address_extender_cntl_agent_m0_write;                                       // ADDRESS_EXTENDER_cntl_agent:m0_write -> ADDRESS_EXTENDER_cntl_translator:uav_write
	wire    [3:0] address_extender_cntl_agent_m0_burstcount;                                  // ADDRESS_EXTENDER_cntl_agent:m0_burstcount -> ADDRESS_EXTENDER_cntl_translator:uav_burstcount
	wire          address_extender_cntl_agent_rf_source_valid;                                // ADDRESS_EXTENDER_cntl_agent:rf_source_valid -> ADDRESS_EXTENDER_cntl_agent_rsp_fifo:in_valid
	wire  [134:0] address_extender_cntl_agent_rf_source_data;                                 // ADDRESS_EXTENDER_cntl_agent:rf_source_data -> ADDRESS_EXTENDER_cntl_agent_rsp_fifo:in_data
	wire          address_extender_cntl_agent_rf_source_ready;                                // ADDRESS_EXTENDER_cntl_agent_rsp_fifo:in_ready -> ADDRESS_EXTENDER_cntl_agent:rf_source_ready
	wire          address_extender_cntl_agent_rf_source_startofpacket;                        // ADDRESS_EXTENDER_cntl_agent:rf_source_startofpacket -> ADDRESS_EXTENDER_cntl_agent_rsp_fifo:in_startofpacket
	wire          address_extender_cntl_agent_rf_source_endofpacket;                          // ADDRESS_EXTENDER_cntl_agent:rf_source_endofpacket -> ADDRESS_EXTENDER_cntl_agent_rsp_fifo:in_endofpacket
	wire          address_extender_cntl_agent_rsp_fifo_out_valid;                             // ADDRESS_EXTENDER_cntl_agent_rsp_fifo:out_valid -> ADDRESS_EXTENDER_cntl_agent:rf_sink_valid
	wire  [134:0] address_extender_cntl_agent_rsp_fifo_out_data;                              // ADDRESS_EXTENDER_cntl_agent_rsp_fifo:out_data -> ADDRESS_EXTENDER_cntl_agent:rf_sink_data
	wire          address_extender_cntl_agent_rsp_fifo_out_ready;                             // ADDRESS_EXTENDER_cntl_agent:rf_sink_ready -> ADDRESS_EXTENDER_cntl_agent_rsp_fifo:out_ready
	wire          address_extender_cntl_agent_rsp_fifo_out_startofpacket;                     // ADDRESS_EXTENDER_cntl_agent_rsp_fifo:out_startofpacket -> ADDRESS_EXTENDER_cntl_agent:rf_sink_startofpacket
	wire          address_extender_cntl_agent_rsp_fifo_out_endofpacket;                       // ADDRESS_EXTENDER_cntl_agent_rsp_fifo:out_endofpacket -> ADDRESS_EXTENDER_cntl_agent:rf_sink_endofpacket
	...
	wire   [98:0] nios_debug_mem_slave_agent_rf_source_data;                                  // NIOS_debug_mem_slave_agent:rf_source_data -> NIOS_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire   [98:0] nios_debug_mem_slave_agent_rsp_fifo_out_data;                               // NIOS_debug_mem_slave_agent_rsp_fifo:out_data -> NIOS_debug_mem_slave_agent:rf_sink_data
	...
	wire   [97:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> NIOS_debug_mem_slave_agent:cp_data
	...
	wire   [98:0] seven_segments_s1_agent_rf_source_data;                                     // SEVEN_SEGMENTS_s1_agent:rf_source_data -> SEVEN_SEGMENTS_s1_agent_rsp_fifo:in_data
	...
	wire   [98:0] seven_segments_s1_agent_rsp_fifo_out_data;                                  // SEVEN_SEGMENTS_s1_agent_rsp_fifo:out_data -> SEVEN_SEGMENTS_s1_agent:rf_sink_data
	...
	wire          cmd_mux_005_src_valid;                                                      // cmd_mux_005:src_valid -> SEVEN_SEGMENTS_s1_agent:cp_valid
	wire   [97:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> SEVEN_SEGMENTS_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                      // SEVEN_SEGMENTS_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> SEVEN_SEGMENTS_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                              // cmd_mux_005:src_startofpacket -> SEVEN_SEGMENTS_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                // cmd_mux_005:src_endofpacket -> SEVEN_SEGMENTS_s1_agent:cp_endofpacket
	...
	wire   [97:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> BUTTONS_s1_agent:cp_data
	...
	wire   [31:0] address_extender_windowed_slave_agent_m0_readdata;                          // ADDRESS_EXTENDER_windowed_slave_translator:uav_readdata -> ADDRESS_EXTENDER_windowed_slave_agent:m0_readdata
	wire          address_extender_windowed_slave_agent_m0_waitrequest;                       // ADDRESS_EXTENDER_windowed_slave_translator:uav_waitrequest -> ADDRESS_EXTENDER_windowed_slave_agent:m0_waitrequest
	wire          address_extender_windowed_slave_agent_m0_debugaccess;                       // ADDRESS_EXTENDER_windowed_slave_agent:m0_debugaccess -> ADDRESS_EXTENDER_windowed_slave_translator:uav_debugaccess
	wire   [18:0] address_extender_windowed_slave_agent_m0_address;                           // ADDRESS_EXTENDER_windowed_slave_agent:m0_address -> ADDRESS_EXTENDER_windowed_slave_translator:uav_address
	wire    [3:0] address_extender_windowed_slave_agent_m0_byteenable;                        // ADDRESS_EXTENDER_windowed_slave_agent:m0_byteenable -> ADDRESS_EXTENDER_windowed_slave_translator:uav_byteenable
	wire          address_extender_windowed_slave_agent_m0_read;                              // ADDRESS_EXTENDER_windowed_slave_agent:m0_read -> ADDRESS_EXTENDER_windowed_slave_translator:uav_read
	wire          address_extender_windowed_slave_agent_m0_readdatavalid;                     // ADDRESS_EXTENDER_windowed_slave_translator:uav_readdatavalid -> ADDRESS_EXTENDER_windowed_slave_agent:m0_readdatavalid
	wire          address_extender_windowed_slave_agent_m0_lock;                              // ADDRESS_EXTENDER_windowed_slave_agent:m0_lock -> ADDRESS_EXTENDER_windowed_slave_translator:uav_lock
	wire   [31:0] address_extender_windowed_slave_agent_m0_writedata;                         // ADDRESS_EXTENDER_windowed_slave_agent:m0_writedata -> ADDRESS_EXTENDER_windowed_slave_translator:uav_writedata
	wire          address_extender_windowed_slave_agent_m0_write;                             // ADDRESS_EXTENDER_windowed_slave_agent:m0_write -> ADDRESS_EXTENDER_windowed_slave_translator:uav_write
	wire    [2:0] address_extender_windowed_slave_agent_m0_burstcount;                        // ADDRESS_EXTENDER_windowed_slave_agent:m0_burstcount -> ADDRESS_EXTENDER_windowed_slave_translator:uav_burstcount
	wire          address_extender_windowed_slave_agent_rf_source_valid;                      // ADDRESS_EXTENDER_windowed_slave_agent:rf_source_valid -> ADDRESS_EXTENDER_windowed_slave_agent_rsp_fifo:in_valid
	wire   [98:0] address_extender_windowed_slave_agent_rf_source_data;                       // ADDRESS_EXTENDER_windowed_slave_agent:rf_source_data -> ADDRESS_EXTENDER_windowed_slave_agent_rsp_fifo:in_data
	wire          address_extender_windowed_slave_agent_rf_source_ready;                      // ADDRESS_EXTENDER_windowed_slave_agent_rsp_fifo:in_ready -> ADDRESS_EXTENDER_windowed_slave_agent:rf_source_ready
	wire          address_extender_windowed_slave_agent_rf_source_startofpacket;              // ADDRESS_EXTENDER_windowed_slave_agent:rf_source_startofpacket -> ADDRESS_EXTENDER_windowed_slave_agent_rsp_fifo:in_startofpacket
	wire          address_extender_windowed_slave_agent_rf_source_endofpacket;                // ADDRESS_EXTENDER_windowed_slave_agent:rf_source_endofpacket -> ADDRESS_EXTENDER_windowed_slave_agent_rsp_fifo:in_endofpacket
	wire          address_extender_windowed_slave_agent_rsp_fifo_out_valid;                   // ADDRESS_EXTENDER_windowed_slave_agent_rsp_fifo:out_valid -> ADDRESS_EXTENDER_windowed_slave_agent:rf_sink_valid
	wire   [98:0] address_extender_windowed_slave_agent_rsp_fifo_out_data;                    // ADDRESS_EXTENDER_windowed_slave_agent_rsp_fifo:out_data -> ADDRESS_EXTENDER_windowed_slave_agent:rf_sink_data
	wire          address_extender_windowed_slave_agent_rsp_fifo_out_ready;                   // ADDRESS_EXTENDER_windowed_slave_agent:rf_sink_ready -> ADDRESS_EXTENDER_windowed_slave_agent_rsp_fifo:out_ready
	wire          address_extender_windowed_slave_agent_rsp_fifo_out_startofpacket;           // ADDRESS_EXTENDER_windowed_slave_agent_rsp_fifo:out_startofpacket -> ADDRESS_EXTENDER_windowed_slave_agent:rf_sink_startofpacket
	wire          address_extender_windowed_slave_agent_rsp_fifo_out_endofpacket;             // ADDRESS_EXTENDER_windowed_slave_agent_rsp_fifo:out_endofpacket -> ADDRESS_EXTENDER_windowed_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_008_src_valid;                                                      // cmd_mux_008:src_valid -> ADDRESS_EXTENDER_windowed_slave_agent:cp_valid
	wire   [97:0] cmd_mux_008_src_data;                                                       // cmd_mux_008:src_data -> ADDRESS_EXTENDER_windowed_slave_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                      // ADDRESS_EXTENDER_windowed_slave_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                    // cmd_mux_008:src_channel -> ADDRESS_EXTENDER_windowed_slave_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                              // cmd_mux_008:src_startofpacket -> ADDRESS_EXTENDER_windowed_slave_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                // cmd_mux_008:src_endofpacket -> ADDRESS_EXTENDER_windowed_slave_agent:cp_endofpacket
	wire          nios_data_master_agent_cp_valid;                                            // NIOS_data_master_agent:cp_valid -> router:sink_valid
	wire   [97:0] nios_data_master_agent_cp_data;                                             // NIOS_data_master_agent:cp_data -> router:sink_data
	...
	wire   [97:0] nios_instruction_master_agent_cp_data;                                      // NIOS_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire          address_extender_cntl_agent_rp_valid;                                       // ADDRESS_EXTENDER_cntl_agent:rp_valid -> router_004:sink_valid
	wire  [133:0] address_extender_cntl_agent_rp_data;                                        // ADDRESS_EXTENDER_cntl_agent:rp_data -> router_004:sink_data
	wire          address_extender_cntl_agent_rp_ready;                                       // router_004:sink_ready -> ADDRESS_EXTENDER_cntl_agent:rp_ready
	wire          address_extender_cntl_agent_rp_startofpacket;                               // ADDRESS_EXTENDER_cntl_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          address_extender_cntl_agent_rp_endofpacket;                                 // ADDRESS_EXTENDER_cntl_agent:rp_endofpacket -> router_004:sink_endofpacket
	wire          nios_debug_mem_slave_agent_rp_valid;                                        // NIOS_debug_mem_slave_agent:rp_valid -> router_005:sink_valid
	wire   [97:0] nios_debug_mem_slave_agent_rp_data;                                         // NIOS_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire          seven_segments_s1_agent_rp_valid;                                           // SEVEN_SEGMENTS_s1_agent:rp_valid -> router_007:sink_valid
	wire   [97:0] seven_segments_s1_agent_rp_data;                                            // SEVEN_SEGMENTS_s1_agent:rp_data -> router_007:sink_data
	wire          seven_segments_s1_agent_rp_ready;                                           // router_007:sink_ready -> SEVEN_SEGMENTS_s1_agent:rp_ready
	wire          seven_segments_s1_agent_rp_startofpacket;                                   // SEVEN_SEGMENTS_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          seven_segments_s1_agent_rp_endofpacket;                                     // SEVEN_SEGMENTS_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire   [97:0] buttons_s1_agent_rp_data;                                                   // BUTTONS_s1_agent:rp_data -> router_008:sink_data
	...
	wire          address_extender_windowed_slave_agent_rp_valid;                             // ADDRESS_EXTENDER_windowed_slave_agent:rp_valid -> router_010:sink_valid
	wire   [97:0] address_extender_windowed_slave_agent_rp_data;                              // ADDRESS_EXTENDER_windowed_slave_agent:rp_data -> router_010:sink_data
	wire          address_extender_windowed_slave_agent_rp_ready;                             // router_010:sink_ready -> ADDRESS_EXTENDER_windowed_slave_agent:rp_ready
	wire          address_extender_windowed_slave_agent_rp_startofpacket;                     // ADDRESS_EXTENDER_windowed_slave_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          address_extender_windowed_slave_agent_rp_endofpacket;                       // ADDRESS_EXTENDER_windowed_slave_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          cmd_mux_002_src_valid;                                                      // cmd_mux_002:src_valid -> ADDRESS_EXTENDER_cntl_cmd_width_adapter:in_valid
	wire   [97:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> ADDRESS_EXTENDER_cntl_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                                      // ADDRESS_EXTENDER_cntl_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [8:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> ADDRESS_EXTENDER_cntl_cmd_width_adapter:in_channel
	wire          cmd_mux_002_src_startofpacket;                                              // cmd_mux_002:src_startofpacket -> ADDRESS_EXTENDER_cntl_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                // cmd_mux_002:src_endofpacket -> ADDRESS_EXTENDER_cntl_cmd_width_adapter:in_endofpacket
	wire          address_extender_cntl_cmd_width_adapter_src_valid;                          // ADDRESS_EXTENDER_cntl_cmd_width_adapter:out_valid -> ADDRESS_EXTENDER_cntl_agent:cp_valid
	wire  [133:0] address_extender_cntl_cmd_width_adapter_src_data;                           // ADDRESS_EXTENDER_cntl_cmd_width_adapter:out_data -> ADDRESS_EXTENDER_cntl_agent:cp_data
	wire          address_extender_cntl_cmd_width_adapter_src_ready;                          // ADDRESS_EXTENDER_cntl_agent:cp_ready -> ADDRESS_EXTENDER_cntl_cmd_width_adapter:out_ready
	wire    [8:0] address_extender_cntl_cmd_width_adapter_src_channel;                        // ADDRESS_EXTENDER_cntl_cmd_width_adapter:out_channel -> ADDRESS_EXTENDER_cntl_agent:cp_channel
	wire          address_extender_cntl_cmd_width_adapter_src_startofpacket;                  // ADDRESS_EXTENDER_cntl_cmd_width_adapter:out_startofpacket -> ADDRESS_EXTENDER_cntl_agent:cp_startofpacket
	wire          address_extender_cntl_cmd_width_adapter_src_endofpacket;                    // ADDRESS_EXTENDER_cntl_cmd_width_adapter:out_endofpacket -> ADDRESS_EXTENDER_cntl_agent:cp_endofpacket
	wire          router_004_src_valid;                                                       // router_004:src_valid -> ADDRESS_EXTENDER_cntl_rsp_width_adapter:in_valid
	wire  [133:0] router_004_src_data;                                                        // router_004:src_data -> ADDRESS_EXTENDER_cntl_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                       // ADDRESS_EXTENDER_cntl_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [8:0] router_004_src_channel;                                                     // router_004:src_channel -> ADDRESS_EXTENDER_cntl_rsp_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                               // router_004:src_startofpacket -> ADDRESS_EXTENDER_cntl_rsp_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                                 // router_004:src_endofpacket -> ADDRESS_EXTENDER_cntl_rsp_width_adapter:in_endofpacket
	wire          address_extender_cntl_rsp_width_adapter_src_valid;                          // ADDRESS_EXTENDER_cntl_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire   [97:0] address_extender_cntl_rsp_width_adapter_src_data;                           // ADDRESS_EXTENDER_cntl_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire          address_extender_cntl_rsp_width_adapter_src_ready;                          // rsp_demux_002:sink_ready -> ADDRESS_EXTENDER_cntl_rsp_width_adapter:out_ready
	wire    [8:0] address_extender_cntl_rsp_width_adapter_src_channel;                        // ADDRESS_EXTENDER_cntl_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire          address_extender_cntl_rsp_width_adapter_src_startofpacket;                  // ADDRESS_EXTENDER_cntl_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire          address_extender_cntl_rsp_width_adapter_src_endofpacket;                    // ADDRESS_EXTENDER_cntl_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	...
	wire    [8:0] rsp_demux_src0_channel;                                                     // rsp_demux:src0_channel -> crosser_001:in_channel
	...
	wire    [8:0] crosser_001_out_channel;                                                    // crosser_001:out_channel -> rsp_mux:sink0_channel
	...
	wire          address_extender_cntl_agent_rdata_fifo_src_valid;                           // ADDRESS_EXTENDER_cntl_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [65:0] address_extender_cntl_agent_rdata_fifo_src_data;                            // ADDRESS_EXTENDER_cntl_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          address_extender_cntl_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_002:in_0_ready -> ADDRESS_EXTENDER_cntl_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                          // avalon_st_adapter_002:out_0_valid -> ADDRESS_EXTENDER_cntl_agent:rdata_fifo_sink_valid
	wire   [65:0] avalon_st_adapter_002_out_0_data;                                           // avalon_st_adapter_002:out_0_data -> ADDRESS_EXTENDER_cntl_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                          // ADDRESS_EXTENDER_cntl_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                          // avalon_st_adapter_002:out_0_error -> ADDRESS_EXTENDER_cntl_agent:rdata_fifo_sink_error
	...
	wire          seven_segments_s1_agent_rdata_fifo_src_valid;                               // SEVEN_SEGMENTS_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] seven_segments_s1_agent_rdata_fifo_src_data;                                // SEVEN_SEGMENTS_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          seven_segments_s1_agent_rdata_fifo_src_ready;                               // avalon_st_adapter_005:in_0_ready -> SEVEN_SEGMENTS_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                          // avalon_st_adapter_005:out_0_valid -> SEVEN_SEGMENTS_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                           // avalon_st_adapter_005:out_0_data -> SEVEN_SEGMENTS_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                          // SEVEN_SEGMENTS_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                          // avalon_st_adapter_005:out_0_error -> SEVEN_SEGMENTS_s1_agent:rdata_fifo_sink_error
	...
	wire          address_extender_windowed_slave_agent_rdata_fifo_src_valid;                 // ADDRESS_EXTENDER_windowed_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] address_extender_windowed_slave_agent_rdata_fifo_src_data;                  // ADDRESS_EXTENDER_windowed_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          address_extender_windowed_slave_agent_rdata_fifo_src_ready;                 // avalon_st_adapter_008:in_0_ready -> ADDRESS_EXTENDER_windowed_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                          // avalon_st_adapter_008:out_0_valid -> ADDRESS_EXTENDER_windowed_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                           // avalon_st_adapter_008:out_0_data -> ADDRESS_EXTENDER_windowed_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                          // ADDRESS_EXTENDER_windowed_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                          // avalon_st_adapter_008:out_0_error -> ADDRESS_EXTENDER_windowed_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) address_extender_cntl_translator (
		.clk                    (CLK_clk_clk),                                  //                      clk.clk
		.reset                  (NIOS_reset_reset_bridge_in_reset_reset),       //                    reset.reset
		.uav_address            (address_extender_cntl_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (address_extender_cntl_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (address_extender_cntl_agent_m0_read),          //                         .read
		.uav_write              (address_extender_cntl_agent_m0_write),         //                         .write
		.uav_waitrequest        (address_extender_cntl_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (address_extender_cntl_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (address_extender_cntl_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (address_extender_cntl_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (address_extender_cntl_agent_m0_writedata),     //                         .writedata
		.uav_lock               (address_extender_cntl_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (address_extender_cntl_agent_m0_debugaccess),   //                         .debugaccess
		.av_write               (ADDRESS_EXTENDER_cntl_write),                  //      avalon_anti_slave_0.write
		.av_read                (ADDRESS_EXTENDER_cntl_read),                   //                         .read
		.av_readdata            (ADDRESS_EXTENDER_cntl_readdata),               //                         .readdata
		.av_writedata           (ADDRESS_EXTENDER_cntl_writedata),              //                         .writedata
		.av_byteenable          (ADDRESS_EXTENDER_cntl_byteenable),             //                         .byteenable
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) address_extender_windowed_slave_translator (
		.clk                    (CLK_clk_clk),                                            //                      clk.clk
		.reset                  (NIOS_reset_reset_bridge_in_reset_reset),                 //                    reset.reset
		.uav_address            (address_extender_windowed_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (address_extender_windowed_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (address_extender_windowed_slave_agent_m0_read),          //                         .read
		.uav_write              (address_extender_windowed_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (address_extender_windowed_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (address_extender_windowed_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (address_extender_windowed_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (address_extender_windowed_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (address_extender_windowed_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (address_extender_windowed_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (address_extender_windowed_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (ADDRESS_EXTENDER_windowed_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (ADDRESS_EXTENDER_windowed_slave_write),                  //                         .write
		.av_read                (ADDRESS_EXTENDER_windowed_slave_read),                   //                         .read
		.av_readdata            (ADDRESS_EXTENDER_windowed_slave_readdata),               //                         .readdata
		.av_writedata           (ADDRESS_EXTENDER_windowed_slave_writedata),              //                         .writedata
		.av_burstcount          (ADDRESS_EXTENDER_windowed_slave_burstcount),             //                         .burstcount
		.av_byteenable          (ADDRESS_EXTENDER_windowed_slave_byteenable),             //                         .byteenable
		.av_readdatavalid       (ADDRESS_EXTENDER_windowed_slave_readdatavalid),          //                         .readdatavalid
		.av_waitrequest         (ADDRESS_EXTENDER_windowed_slave_waitrequest),            //                         .waitrequest
		.av_begintransfer       (),                                                       //              (terminated)
		.av_beginbursttransfer  (),                                                       //              (terminated)
		.av_writebyteenable     (),                                                       //              (terminated)
		.av_lock                (),                                                       //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) address_extender_cntl_agent (
		.clk                     (CLK_clk_clk),                                               //             clk.clk
		.reset                   (NIOS_reset_reset_bridge_in_reset_reset),                    //       clk_reset.reset
		.m0_address              (address_extender_cntl_agent_m0_address),                    //              m0.address
		.m0_burstcount           (address_extender_cntl_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (address_extender_cntl_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (address_extender_cntl_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (address_extender_cntl_agent_m0_lock),                       //                .lock
		.m0_readdata             (address_extender_cntl_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (address_extender_cntl_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (address_extender_cntl_agent_m0_read),                       //                .read
		.m0_waitrequest          (address_extender_cntl_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (address_extender_cntl_agent_m0_writedata),                  //                .writedata
		.m0_write                (address_extender_cntl_agent_m0_write),                      //                .write
		.rp_endofpacket          (address_extender_cntl_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (address_extender_cntl_agent_rp_ready),                      //                .ready
		.rp_valid                (address_extender_cntl_agent_rp_valid),                      //                .valid
		.rp_data                 (address_extender_cntl_agent_rp_data),                       //                .data
		.rp_startofpacket        (address_extender_cntl_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (address_extender_cntl_cmd_width_adapter_src_ready),         //              cp.ready
		.cp_valid                (address_extender_cntl_cmd_width_adapter_src_valid),         //                .valid
		.cp_data                 (address_extender_cntl_cmd_width_adapter_src_data),          //                .data
		.cp_startofpacket        (address_extender_cntl_cmd_width_adapter_src_startofpacket), //                .startofpacket
		.cp_endofpacket          (address_extender_cntl_cmd_width_adapter_src_endofpacket),   //                .endofpacket
		.cp_channel              (address_extender_cntl_cmd_width_adapter_src_channel),       //                .channel
		.rf_sink_ready           (address_extender_cntl_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (address_extender_cntl_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (address_extender_cntl_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (address_extender_cntl_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (address_extender_cntl_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (address_extender_cntl_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (address_extender_cntl_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (address_extender_cntl_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (address_extender_cntl_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (address_extender_cntl_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                         //                .error
		.rdata_fifo_src_ready    (address_extender_cntl_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (address_extender_cntl_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (address_extender_cntl_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) address_extender_cntl_agent_rsp_fifo (
		.clk               (CLK_clk_clk),                                            //       clk.clk
		.reset             (NIOS_reset_reset_bridge_in_reset_reset),                 // clk_reset.reset
		.in_data           (address_extender_cntl_agent_rf_source_data),             //        in.data
		.in_valid          (address_extender_cntl_agent_rf_source_valid),            //          .valid
		.in_ready          (address_extender_cntl_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (address_extender_cntl_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (address_extender_cntl_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (address_extender_cntl_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (address_extender_cntl_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (address_extender_cntl_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (address_extender_cntl_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (address_extender_cntl_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                  // (terminated)
		.csr_read          (1'b0),                                                   // (terminated)
		.csr_write         (1'b0),                                                   // (terminated)
		.csr_readdata      (),                                                       // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) address_extender_windowed_slave_agent (
		.clk                     (CLK_clk_clk),                                                      //             clk.clk
		.reset                   (NIOS_reset_reset_bridge_in_reset_reset),                           //       clk_reset.reset
		.m0_address              (address_extender_windowed_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (address_extender_windowed_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (address_extender_windowed_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (address_extender_windowed_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (address_extender_windowed_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (address_extender_windowed_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (address_extender_windowed_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (address_extender_windowed_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (address_extender_windowed_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (address_extender_windowed_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (address_extender_windowed_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (address_extender_windowed_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (address_extender_windowed_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (address_extender_windowed_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (address_extender_windowed_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (address_extender_windowed_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (address_extender_windowed_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (address_extender_windowed_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (address_extender_windowed_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (address_extender_windowed_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (address_extender_windowed_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (address_extender_windowed_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (address_extender_windowed_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (address_extender_windowed_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (address_extender_windowed_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (address_extender_windowed_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),                                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),                                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),                                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),                                //                .error
		.rdata_fifo_src_ready    (address_extender_windowed_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (address_extender_windowed_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (address_extender_windowed_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) address_extender_windowed_slave_agent_rsp_fifo (
		.clk               (CLK_clk_clk),                                                      //       clk.clk
		.reset             (NIOS_reset_reset_bridge_in_reset_reset),                           // clk_reset.reset
		.in_data           (address_extender_windowed_slave_agent_rf_source_data),             //        in.data
		.in_valid          (address_extender_windowed_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (address_extender_windowed_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (address_extender_windowed_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (address_extender_windowed_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (address_extender_windowed_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (address_extender_windowed_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (address_extender_windowed_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (address_extender_windowed_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (address_extender_windowed_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                            // (terminated)
		.csr_read          (1'b0),                                                             // (terminated)
		.csr_write         (1'b0),                                                             // (terminated)
		.csr_readdata      (),                                                                 // (terminated)
	...
	soc_audio_mm_interconnect_0_router router (
	...
	soc_audio_mm_interconnect_0_router_001 router_001 (
	...
	soc_audio_mm_interconnect_0_router_002 router_002 (
	...
	soc_audio_mm_interconnect_0_router_002 router_003 (
	...
	soc_audio_mm_interconnect_0_router_004 router_004 (
		.sink_ready         (address_extender_cntl_agent_rp_ready),         //      sink.ready
		.sink_valid         (address_extender_cntl_agent_rp_valid),         //          .valid
		.sink_data          (address_extender_cntl_agent_rp_data),          //          .data
		.sink_startofpacket (address_extender_cntl_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (address_extender_cntl_agent_rp_endofpacket),   //          .endofpacket
		.clk                (CLK_clk_clk),                                  //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_router_005 router_005 (
	...
	soc_audio_mm_interconnect_0_router_005 router_006 (
	...
	soc_audio_mm_interconnect_0_router_002 router_007 (
	...
	soc_audio_mm_interconnect_0_router_002 router_008 (
	...
	soc_audio_mm_interconnect_0_router_002 router_009 (
	...
	soc_audio_mm_interconnect_0_router_002 router_010 (
		.sink_ready         (address_extender_windowed_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (address_extender_windowed_slave_agent_rp_valid),         //          .valid
		.sink_data          (address_extender_windowed_slave_agent_rp_data),          //          .data
		.sink_startofpacket (address_extender_windowed_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (address_extender_windowed_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (CLK_clk_clk),                                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset),                 // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (AUDIO_CLOCK_audio_clk_clk),               //       clk.clk
		.reset               (AUDIO_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (AUDIO_CLOCK_audio_clk_clk),               //       clk.clk
		.reset              (AUDIO_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (CLK_clk_clk),                                               //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		.sink_ready         (address_extender_cntl_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (address_extender_cntl_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (address_extender_cntl_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (address_extender_cntl_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (address_extender_cntl_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (address_extender_cntl_rsp_width_adapter_src_valid),         //          .valid
	...
	soc_audio_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_rsp_demux_001 rsp_demux_006 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_rsp_demux_001 rsp_demux_007 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_rsp_demux_001 rsp_demux_008 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_audio_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
	...
	) address_extender_cntl_cmd_width_adapter (
		.clk                  (CLK_clk_clk),                                               //       clk.clk
		.reset                (NIOS_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.out_endofpacket      (address_extender_cntl_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (address_extender_cntl_cmd_width_adapter_src_data),          //          .data
		.out_channel          (address_extender_cntl_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (address_extender_cntl_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (address_extender_cntl_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (address_extender_cntl_cmd_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) address_extender_cntl_rsp_width_adapter (
		.clk                  (CLK_clk_clk),                                               //       clk.clk
		.reset                (NIOS_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.out_endofpacket      (address_extender_cntl_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (address_extender_cntl_rsp_width_adapter_src_data),          //          .data
		.out_channel          (address_extender_cntl_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (address_extender_cntl_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (address_extender_cntl_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (address_extender_cntl_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                     // (terminated)
	);
	...
	soc_audio_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	soc_audio_mm_interconnect_0_avalon_st_adapter_002 #(
		.inBitsPerSymbol (66),
		.inUsePackets    (0),
		.inDataWidth     (66),
		.inChannelWidth  (0),
		...
		.in_clk_0_clk   (CLK_clk_clk),                                      // in_clk_0.clk
		.in_rst_0_reset (NIOS_reset_reset_bridge_in_reset_reset),           // in_rst_0.reset
		.in_0_data      (address_extender_cntl_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (address_extender_cntl_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (address_extender_cntl_agent_rdata_fifo_src_ready), //         .ready
	...
	soc_audio_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (CLK_clk_clk),                                                // in_clk_0.clk
		.in_rst_0_reset (NIOS_reset_reset_bridge_in_reset_reset),                     // in_rst_0.reset
		.in_0_data      (address_extender_windowed_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (address_extender_windowed_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (address_extender_windowed_slave_agent_rdata_fifo_src_ready), //         .ready
