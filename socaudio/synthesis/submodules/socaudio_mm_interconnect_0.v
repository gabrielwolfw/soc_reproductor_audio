...
`timescale 1 ps / 1 ps
module socaudio_mm_interconnect_0 (
		...
		output wire [12:0] SHARED_MEMORY_s1_address,                //                 SHARED_MEMORY_s1.address
	...
	wire  [92:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> NIOS_debug_mem_slave_agent:cp_data
	...
	wire  [16:0] seven_segments_s1_agent_m0_address;                                         // SEVEN_SEGMENTS_s1_agent:m0_address -> SEVEN_SEGMENTS_s1_translator:uav_address
	...
	wire  [93:0] seven_segments_s1_agent_rf_source_data;                                     // SEVEN_SEGMENTS_s1_agent:rf_source_data -> SEVEN_SEGMENTS_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] seven_segments_s1_agent_rsp_fifo_out_data;                                  // SEVEN_SEGMENTS_s1_agent_rsp_fifo:out_data -> SEVEN_SEGMENTS_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> SEVEN_SEGMENTS_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                      // SEVEN_SEGMENTS_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> SEVEN_SEGMENTS_s1_agent:cp_channel
	...
	wire  [16:0] shared_memory_s1_agent_m0_address;                                          // SHARED_MEMORY_s1_agent:m0_address -> SHARED_MEMORY_s1_translator:uav_address
	...
	wire  [93:0] shared_memory_s1_agent_rf_source_data;                                      // SHARED_MEMORY_s1_agent:rf_source_data -> SHARED_MEMORY_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] shared_memory_s1_agent_rsp_fifo_out_data;                                   // SHARED_MEMORY_s1_agent_rsp_fifo:out_data -> SHARED_MEMORY_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                      // cmd_mux_007:src_valid -> SHARED_MEMORY_s1_agent:cp_valid
	wire  [92:0] cmd_mux_007_src_data;                                                       // cmd_mux_007:src_data -> SHARED_MEMORY_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                      // SHARED_MEMORY_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                    // cmd_mux_007:src_channel -> SHARED_MEMORY_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                              // cmd_mux_007:src_startofpacket -> SHARED_MEMORY_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                // cmd_mux_007:src_endofpacket -> SHARED_MEMORY_s1_agent:cp_endofpacket
	...
	wire  [92:0] nios_debug_mem_slave_agent_rp_data;                                         // NIOS_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [92:0] seven_segments_s1_agent_rp_data;                                            // SEVEN_SEGMENTS_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] shared_memory_s1_agent_rp_data;                                             // SHARED_MEMORY_s1_agent:rp_data -> router_009:sink_data
	...
	wire         shared_memory_s1_agent_rdata_fifo_src_valid;                                // SHARED_MEMORY_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] shared_memory_s1_agent_rdata_fifo_src_data;                                 // SHARED_MEMORY_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         shared_memory_s1_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_007:in_0_ready -> SHARED_MEMORY_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                          // avalon_st_adapter_007:out_0_valid -> SHARED_MEMORY_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                           // avalon_st_adapter_007:out_0_data -> SHARED_MEMORY_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                          // SHARED_MEMORY_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                          // avalon_st_adapter_007:out_0_error -> SHARED_MEMORY_s1_agent:rdata_fifo_sink_error
	...
	socaudio_mm_interconnect_0_router router (
	...
	socaudio_mm_interconnect_0_router_001 router_001 (
	...
	socaudio_mm_interconnect_0_router_002 router_002 (
	...
	socaudio_mm_interconnect_0_router_002 router_003 (
	...
	socaudio_mm_interconnect_0_router_004 router_004 (
	...
	socaudio_mm_interconnect_0_router_004 router_005 (
	...
	socaudio_mm_interconnect_0_router_002 router_006 (
	...
	socaudio_mm_interconnect_0_router_002 router_007 (
	...
	socaudio_mm_interconnect_0_router_002 router_008 (
	...
	socaudio_mm_interconnect_0_router_002 router_009 (
	...
	socaudio_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (CLK_clk_clk),                            //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
