...
module socaudio_mm_interconnect_0 (
	...
	wire  [91:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> JTAG_UART_avalon_jtag_slave_agent:cp_data
	...
	wire   [6:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> SEVEN_SEGMENTS_s1_agent:cp_channel
	...
	wire  [91:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> TIMER_s1_agent:cp_data
	...
	wire  [91:0] timer_s1_agent_rp_data;                                                     // TIMER_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [91:0] router_src_data;                                                            // router:src_data -> NIOS_data_master_limiter:cmd_sink_data
	...
	wire  [91:0] nios_data_master_limiter_cmd_src_data;                                      // NIOS_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [91:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> NIOS_data_master_limiter:rsp_sink_data
	...
	wire  [91:0] nios_data_master_limiter_rsp_src_data;                                      // NIOS_data_master_limiter:rsp_src_data -> NIOS_data_master_agent:rp_data
	...
	wire  [91:0] router_001_src_data;                                                        // router_001:src_data -> NIOS_instruction_master_limiter:cmd_sink_data
	...
	wire  [91:0] nios_instruction_master_limiter_cmd_src_data;                               // NIOS_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [91:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> NIOS_instruction_master_limiter:rsp_sink_data
	...
	wire  [91:0] nios_instruction_master_limiter_rsp_src_data;                               // NIOS_instruction_master_limiter:rsp_src_data -> NIOS_instruction_master_agent:rp_data
	...
	socaudio_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	socaudio_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
